...
# Clean data
# Filter out days when the page views were in the top 2.5% of the dataset
# and bottom 2.5% of the dataset
...
# Para testar as funções, segue um passo a passo comentado:
...
# Exemplo de como executar individualmente:
# fig1 = draw_line_plot()
# fig2 = draw_bar_plot()
# fig3 = draw_box_plot()
# plt.show()  # Para mostrar todos os gráficos